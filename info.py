...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
FQDN = str(getenv('FQDN', 'BIND_ADRESS:PORT')) if not ON_HEROKU or getenv('FQDN', 'https://zoophagous-lauree-file-to-link-prime-bot-38c42d2f.koyeb.app/') else APP_NAME+'.herokuapp.com'
